...
('technology', 'Technology', 'Learn about the newest tech trends and innovations.', 'FiCpu', 'text-purple-600', 'bg-purple-100'),
('travel', 'Travel', 'Get tips and inspiration for your next adventure.', 'FiGlobe', 'text-blue-600', 'bg-blue-100'),
('fitness', 'Fitness', 'Discover ways to stay fit and healthy.', 'FiActivity', 'text-green-600', 'bg-green-100'),
('politics', 'Politics', 'Stay updated with the latest political developments.', 'FiTrendingUp', 'text-red-600', 'bg-red-100')
